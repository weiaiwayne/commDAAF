...
| **Data Analyst 2** | Gemini | Gemini | Market data, correlation analysis |
...
# Gemini - Market collection
# Run in Gemini interface with this prompt:
"
FIRST: Read skills/commdaaf/SKILL.md and activate CommDAAF guardrails.
Confirm: 'CommDAAF v1.0 activated. Validation tier: 🟢 EXPLORATORY.'
...
**For Gemini:**
- Large context window — can handle full datasets
- Strong reasoning for statistical analysis
- Focus on correlation/causality analysis
- Report confidence intervals (CommDAAF requirement)
- Use explicit JSON formatting in prompts for structured outputs
