...
const content = readFileSync('/root/.openclaw/workspace/projects/vibepolitics/research/AGENT_FEEDBACK_SYNTHESIS.html', 'utf8');
...
blockquote { border-left: 4px solid #3182ce; margin: 1em 0; padding-left: 1em; color: #4a5568; background: #f7fafc; padding: 1em; }
...
await page.pdf({ 
  path: '/root/.openclaw/workspace/projects/vibepolitics/research/AGENT_FEEDBACK_SYNTHESIS.pdf',
  format: 'A4',
